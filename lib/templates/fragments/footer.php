...
function beans_footer_content() { 
   beans_open_markup_e( 'beans_footer_credit', 'div', array( 'class' => 'uk-clearfix uk-text-small uk-text-muted' ) );
		...
		$right_framework_link = beans_open_markup(
			...
			$right_framework_link .= beans_output( 'beans_footer_credit_framework_link_text', 'Beans' );

		$right_framework_link .= beans_close_markup( 'beans_footer_credit_framework_link', 'a' );
